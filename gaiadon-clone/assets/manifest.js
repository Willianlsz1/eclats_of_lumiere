// AUTO-GERADO por assets/eclats/_gen_manifest.py — nao editar a mao.
// Mapa id -> caminho (sem extensao, relativo a index.html). CP-0.
(function (global) {
  const BASE = "assets/eclats/";
  const DATA = {
  "backgrounds": {
  ...
  "verify": [
    ...
    "enemies/map1/enemy_VERIFICAR_constellation_weaver",
    "enemies/map1/enemy_VERIFICAR_deer_spirit",
    "enemies/map1/enemy_VERIFICAR_golden_figure",
    "enemies/map1/enemy_VERIFICAR_moth_lantern",
...
};   // relpath -> extensao do original (default .png)
